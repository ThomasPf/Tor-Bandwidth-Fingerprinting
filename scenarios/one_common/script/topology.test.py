...
G.add_node("r4", type="relay", ip="0.0.0.2", geocode="EU", bandwidthup=10240, bandwidthdown=10240, packetloss=0.0)
G.add_node("r5", type="relay", ip="0.0.0.3", geocode="EU", bandwidthup=10240, bandwidthdown=10240, packetloss=0.0)
...
G.add_edge("r1", "r4", latency=50.0, jitter=0.0, packetloss=0.0)
G.add_edge("r4", "r5", latency=50.0, jitter=0.0, packetloss=0.0)
G.add_edge("r5", "s", latency=50.0, jitter=0.0, packetloss=0.0)
