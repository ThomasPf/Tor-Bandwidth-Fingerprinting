...
def generate(args):
    ...
    if n_exitguards == 0 and n_guards == 0:
        ...
        n_guards = 1
    if n_exits == 0:
        log("Warning: Must have at least 1 exit node, setting to 1")
        n_exits = 1
    if n_middles == 0:
    ...
    log("Done getting servers from alexa data")
    ...
    log("Done writing tgen config files")
    ...
    log("Done writing directory authority servers")
    ...
    log("Done writing bridge authority servers")
    ...
    log("Done writing exit guard relays")
    ...
    log("Done writing middle relays")
    ...
    with open("shadow.config.xml", 'wb') as fhosts:
        ...
        log("Done writing shadow.config.xml")
